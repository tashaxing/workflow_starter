...
#include <stdint.h>
#include <utility>
#include "PlatformSocket.h" // cross platform header
#include "message.h"

int MyMessage::encode(struct iovec vectors[], int max/*max==8192*/)
{
...
int MyMessage::append(const void *buf, size_t size)
{
...
int MyMessage::set_message_body(const void *body, size_t size)
{
	void *p = malloc(size);
...
MyMessage& MyMessage::operator = (MyMessage&& msg)
{
	if (&msg != this)
	{
